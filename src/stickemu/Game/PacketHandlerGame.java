 ...
 */
package stickemu.Game;
import stickemu.Types.StickClient;
import stickemu.Tools.StickPacketMaker;
import stickemu.Lobby.handlers.*;
import stickemu.Game.handlers.*;
/**
 *
 * @author Simon
 */
        ...
        //public static object HandlePacket(object state)
        {
          //  PacketData PD = (PacketData)state;
           ...
           // Console.WriteLine("Packet being handled from " + client.getName() + " : " + Packet);
                ...
                Packet.substring(0,1).equalsIgnoreCase("5") || Packet.substring(0,1).equalsIgnoreCase("7") ||
                Packet.substring(0,1).equalsIgnoreCase("8"))
                {
